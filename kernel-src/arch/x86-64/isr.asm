...
global asm_nmi_handler
asm_nmi_handler:
	sub rsp, 8 ; error code, unused for nmi
	push rbp
	sub rsp, 8 ; vec number, unused for nmi
	push rsi
	push rdi
	push r15
	push r14
	...
	pop rdi
	pop rsi
	add rsp, 8 ; vector num, unused for nmi
	pop rbp
	add rsp, 8 ; error code, unused for nmi
